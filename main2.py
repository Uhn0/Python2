...
def create_enemy():
    # enemy = pygame.Surface((5, 5))
    # enemy.fill(RED)
    enemy = pygame.image.load('enemy.png').convert_alpha()
    enemy_rect = pygame.Rect(width , random.randint(0, heigth - 50), *enemy.get_size())
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(50, width -50),-100, *bonus.get_size())
